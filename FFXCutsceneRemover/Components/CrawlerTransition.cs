...
class CrawlerTransition : Transition
{
    ...
    public override void Execute(string defaultDescription = "")
    {
        ...
        if (MemoryWatchers.CrawlerTransition.Current > 0)
        {
            ...
            else if (MemoryWatchers.CrawlerTransition.Current == (BaseCutsceneValue + 0xF1E6) && MemoryWatchers.HpEnemyA.Current < 16000 && MemoryWatchers.HpEnemyA.Old == 16000 && Stage == 6)
            {
