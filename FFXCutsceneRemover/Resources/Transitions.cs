...
namespace FFXCutsceneRemover.Resources
{
    ...
    static class Transitions
    {
        ...
        public static readonly Dictionary<IGameState, Transition> StandardTransitions = new Dictionary<IGameState, Transition>()
            ...
            { new GameState { RoomNumber = 0, Storyline = 0, CutsceneAlt = 18, Dialogue1 = 6}, new NewGameTransition { ForceLoad = false, ConsoleOutput = false } },
            // START OF ZANARKAND
        ...
        public static readonly Dictionary<IGameState, Transition> PostBossBattleTransitions = new Dictionary<IGameState, Transition>()
        {
            ...
            { new GameState { BattleLocationID = 87, BattleEncounterID = 3 }, new Transition { RoomNumber = 280, Storyline = 1940, SpawnPoint = 4, Description = "Home Chimera"} },
