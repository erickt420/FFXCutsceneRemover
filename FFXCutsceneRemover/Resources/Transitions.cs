...
namespace FFXCutsceneRemover.Resources
{
    ...
    static class Transitions
    {
        ...
        public static readonly Dictionary<IGameState, Transition> StandardTransitions = new Dictionary<IGameState, Transition>()
            ...
            { new GameState { RoomNumber = 140, Storyline = 1310, ThunderPlainsFlag = 0x0C}, new Transition { RoomNumber = 256, Storyline = 1310, SpawnPoint = 0, ThunderPlainsFlag = 0x1C, Description = "Rikku freaks out"} },
            { new GameState { RoomNumber = 140, Storyline = 1310, ThunderPlainsFlag = 0x0D}, new Transition { RoomNumber = 256, Storyline = 1310, SpawnPoint = 0, ThunderPlainsFlag = 0x1D, Description = "Rikku freaks out"} },
            { new GameState { RoomNumber = 140, Storyline = 1310, ThunderPlainsFlag = 0x0E}, new Transition { RoomNumber = 256, Storyline = 1310, SpawnPoint = 0, ThunderPlainsFlag = 0x1E, Description = "Rikku freaks out"} },
            { new GameState { RoomNumber = 140, Storyline = 1310, ThunderPlainsFlag = 0x0F}, new Transition { RoomNumber = 256, Storyline = 1310, SpawnPoint = 0, ThunderPlainsFlag = 0x1F, Description = "Rikku freaks out"} },
